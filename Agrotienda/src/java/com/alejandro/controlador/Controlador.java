...
import com.alejandro.config.Fecha;
import com.alejandro.modelo.Carrito;
import com.alejandro.modelo.Cliente;
import com.alejandro.modelo.ClienteDAO;
import com.alejandro.modelo.Compra;
import com.alejandro.modelo.ComprasDAO;
import com.alejandro.modelo.DetalleCompra;
import com.alejandro.modelo.Pago;
import com.alejandro.modelo.Producto;
import com.alejandro.modelo.ProductoDAO;
import java.io.File;
...
public class Controlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (accion) {
            ...
            case "GenerarCompra":
                idpago = cdao.IdPago();
                if (cl.getId() != 0 && !listaProductos.isEmpty() && montopagar > 0) {
                    if (totalPagar > 0.0) {
